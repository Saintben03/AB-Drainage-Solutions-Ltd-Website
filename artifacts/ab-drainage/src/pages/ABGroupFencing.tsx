...
export default function ABGroupFencing() {
  ...
  return (
    <>
      ...
      <OrganicDivider from={WHITE} to={DARK} flip />
      ...
      <section id="services" className="py-24" style={{ backgroundColor: DARK }}>
        <div className="container mx-auto px-4 lg:px-8">
          ...
          <motion.div variants={stagger} initial="hidden" whileInView="show" viewport={{ once: true }} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s) => (
              <motion.div key={s.title} variants={fadeUp} className="bg-zinc-900 border border-zinc-800 p-8 group hover:border-[#16a34a]/50 transition-all duration-300">
      ...
      <OrganicDivider from={DARK} to={WHITE} />
