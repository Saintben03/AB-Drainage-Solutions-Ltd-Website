...
export default function Gallery() {
  return (
    <>
      ...
      <PageHero
        image={heroImg}
        imageAlt="A&B Drainage fleet and engineers"
        eyebrow={<><Camera size={15} aria-hidden="true" /> A&B In Action</>}
        title={<>Our <span className="text-accent">Gallery</span></>}
        description="Real photos of our team, our fleet and our work across Hampshire — no stock images, just three decades of drainage expertise on the ground."
        waveFill="#ffffff"
      />
