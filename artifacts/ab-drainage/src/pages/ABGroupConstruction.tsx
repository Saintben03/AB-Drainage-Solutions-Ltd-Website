      ...
      <section className="relative min-h-[92vh] flex items-end overflow-hidden bg-background">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: "easeOut" }} className="max-w-3xl">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-white/50 text-xs uppercase tracking-[0.18em]">Civil Engineering Division</p>
              </div>
            </div>
        ...
        <div aria-hidden="true" className="absolute bottom-0 left-0 right-0 overflow-hidden pointer-events-none h-20">
          <svg viewBox="0 0 1440 80" preserveAspectRatio="none" className="absolute bottom-0 w-full h-full">
            <polygon points="0,80 0,80 1440,20 1440,80" fill={WHITE} />
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div initial={{ opacity: 0, x: -24 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              ...
              <h2 className="text-4xl md:text-5xl font-display font-bold text-zinc-900 uppercase leading-tight mb-6">Built on Solid<br />Foundations</h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5 }}>
              ...
              <div className="space-y-4">
                <a href="tel:01256688650" className="flex items-center gap-3 text-zinc-800 hover:text-[#dc2626] transition-colors">
                ...
                <a href="mailto:info@abdrainage.co.uk" className="flex items-center gap-3 text-zinc-800 hover:text-[#dc2626] transition-colors">
                ...
                <form onSubmit={handleSubmit} className="bg-white border border-zinc-200 shadow-lg p-8 space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input name="name" value={form.name} onChange={handleChange} required className="w-full bg-white border border-zinc-300 text-zinc-900 px-4 py-3 text-sm focus:outline-none focus:border-[#dc2626] transition-colors" placeholder="Your name" />
                    </div>
                    <div>
                      <label className="block text-zinc-600 text-xs uppercase tracking-[0.15em] font-bold mb-2">Phone</label>
                      <input name="phone" value={form.phone} onChange={handleChange} className="w-full bg-white border border-zinc-300 text-zinc-900 px-4 py-3 text-sm focus:outline-none focus:border-[#dc2626] transition-colors" placeholder="Your number" />
                    </div>
                  </div>
                  <div>
                    <label className="block text-zinc-600 text-xs uppercase tracking-[0.15em] font-bold mb-2">Email Address *</label>
                    <input name="email" type="email" value={form.email} onChange={handleChange} required className="w-full bg-white border border-zinc-300 text-zinc-900 px-4 py-3 text-sm focus:outline-none focus:border-[#dc2626] transition-colors" placeholder="your@email.com" />
                  </div>
                  <div>
                    <label className="block text-zinc-600 text-xs uppercase tracking-[0.15em] font-bold mb-2">Service Required</label>
                    <select name="service" value={form.service} onChange={handleChange} className="w-full bg-white border border-zinc-300 text-zinc-900 px-4 py-3 text-sm focus:outline-none focus:border-[#dc2626] transition-colors">
        ...
        <div className="container mx-auto px-4 lg:px-8">
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div>
              ...
              <p className="text-white/80 text-sm mt-1">Construction, drainage, fencing and facilities — all under one roof</p>
            </div>
            <div className="flex gap-4 flex-wrap">
              ...
              <a href="https://www.abdrainage.co.uk" target="_blank" rel="noopener noreferrer" className="px-6 py-3 text-xs font-bold uppercase tracking-wider text-[#dc2626] bg-white hover:opacity-90 transition-all">AB Drainage</a>
            </div>
          </div>
        </div>
      </section>
