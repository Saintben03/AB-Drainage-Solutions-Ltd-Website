...
const heroImg = "https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=1920&q=85&auto=format&fit=crop";
...
const services = [
  {
    ...
    desc: "Full site preparation, bulk excavation, trenching and soil management to specification and programme.",
  },
  {
    icon: <Layers size={26} />,
    title: "Civil Engineering",
    desc: "Roads, pathways, retaining structures, drainage networks and concrete works for residential and commercial clients.",
  },
  {
    icon: <Building2 size={26} />,
    title: "Structural Works",
    desc: "Foundation laying, underpinning, concrete frames and structural repair to the highest building regulations standards.",
  },
  {
    icon: <Truck size={26} />,
    title: "Site Clearance",
    desc: "Rapid, responsible clearance of vegetation, demolition material and waste — fully licenced and insured.",
  },
  {
    icon: <HardHat size={26} />,
    title: "Concrete Works",
    desc: "Reinforced slabs, in-situ concrete pours, brickwork and blockwork for a wide range of construction applications.",
  },
  {
    icon: <ClipboardList size={26} />,
    title: "Project Management",
    desc: "End-to-end programme management, sub-contractor coordination and full CDM compliance from start to finish.",
  },
];

const gallery = [
  { src: heroImg, caption: "Precision groundworks on a Hampshire development site" },
  ...
  { src: img4, caption: "Drainage and pipeline installation as part of a major civil contract" },
    ...
    <>
      ...
      <section className="relative min-h-[92vh] flex items-end overflow-hidden bg-background">
        <div className="absolute inset-0">
          <img
            src={heroImg}
            alt="AB Construction Solutions groundworks"
        ...
        <div className="relative z-10 container mx-auto px-4 lg:px-8 pb-24 pt-16">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl xl:text-8xl font-display font-black uppercase text-white leading-[0.9] mb-6 relative">
              ...
              <br />
              <span className="text-[#dc2626]">Solutions Ltd</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="#enquire"
                className="inline-flex items-center gap-2 px-10 py-5 text-white font-bold uppercase tracking-wider text-sm transition-all"
          ...
          >
            {services.map((s) => (
              <motion.div
                key={s.title}
                variants={fadeUp}
                className="bg-zinc-900 border border-zinc-800 p-8 group hover:border-[#dc2626]/40 transition-all duration-300"
              >
            ...
            >
              ...
              <div className="space-y-4">
                <a href="tel:01256688650" className="flex items-center gap-3 text-white hover:text-[#dc2626] transition-colors">
                  <div className="w-10 h-10 bg-[#dc2626]/10 border border-[#dc2626]/30 flex items-center justify-center">
            ...
            >
              {sent ? (
                <div className="bg-zinc-900 border border-[#dc2626]/40 p-12 text-center">
                  ...
                  <button onClick={() => setSent(false)} className="mt-6 text-[#dc2626] text-sm font-bold uppercase tracking-wider hover:underline">
                    Send Another
                  </button>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="bg-zinc-900 border border-zinc-800 p-8 space-y-5">
                  <div className="grid sm:grid-cols-2 gap-5">
                    <div>
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-zinc-800 border border-zinc-700 text-white px-4 py-3 text-sm focus:outline-none focus:border-[#dc2626] transition-colors"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full bg-zinc-800 border border-zinc-700 text-white px-4 py-3 text-sm focus:outline-none focus:border-[#dc2626] transition-colors resize-none"
